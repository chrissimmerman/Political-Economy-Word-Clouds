...
martineau_wc = WordCloud(font_path="C:\\WINDOWS\\FONTS\\sylfaen.TTF", max_words = 920000, mask = martineauMask, stopwords=stopwords, background_color= "white")
...
plt.axis("off")
plt.savefig("C:\\Users\\chris\\Documents\\GitHub\\Political-Economy-Word-Clouds\\martineauCloudWhite.png", dpi = 300)
plt.show()
